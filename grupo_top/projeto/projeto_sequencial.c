...
void EulerTest(int precisao, mpf_t resultado) {
  mpf_t stepResult;  // MPF representa funções aritméticas de ponto flutuante de alto nível de precisão 
  mpf_init2(resultado_parcial, 8192); // Inicializa a variável para resultado parcial
  mpz_t fatorial;
  mpz_init(fatorial); // Inicializa a variável armazenando fatoriais

  mpf_init2(fatorial, 8192); // Inicializa o resultado final
